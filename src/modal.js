...
window.showAlert = function(message) {
    ...
    <div id="customAlertModal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); display: flex; justify-content: center; align-items: center; z-index: 100000;">
        <div style="background: #f0d9b5; padding: 30px; border-radius: 8px; border: 4px solid #2e2e2e; min-width: 300px; max-width: 80%; text-align: center; font-family: 'Georgia', serif; box-shadow: 0 4px 15px rgba(0,0,0,0.5);">
            ...
            <button onclick="document.getElementById('customAlertModal').remove()" style="width: 100%; padding: 12px; background: #2e2e2e; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: normal; letter-spacing: 1px; font-family: 'Lilita One', cursive; font-size: 16px; transition: background 0.2s; -webkit-text-stroke: 0; text-shadow: none;">OK</button>
        </div>
    </div>
    `;
    ...
    return new Promise((resolve) => {
        ...
        <div id="customConfirmModal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); display: flex; justify-content: center; align-items: center; z-index: 100000;">
            <div style="background: #f0d9b5; padding: 30px; border-radius: 8px; border: 4px solid #2e2e2e; min-width: 300px; max-width: 80%; text-align: center; font-family: 'Georgia', serif; box-shadow: 0 4px 15px rgba(0,0,0,0.5);">
                ...
                <p style="color: #2e2e2e; font-size: 16px; margin-bottom: 25px; white-space: pre-wrap; line-height: 1.5; word-break: break-word;">${message}</p>
                <div class="responsive-modal-buttons" style="display: flex; gap: 10px; justify-content: center;">
                    <button id="customConfirmCancelBtn" style="flex: 1; padding: 12px; background: #e53e3e; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: normal; letter-spacing: 1px; font-family: 'Lilita One', cursive; font-size: 16px; transition: background 0.2s; -webkit-text-stroke: 0; text-shadow: none;">Cancel</button>
                    <button id="customConfirmOkBtn" style="flex: 1; padding: 12px; background: #829769; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: normal; letter-spacing: 1px; font-family: 'Lilita One', cursive; font-size: 16px; transition: background 0.2s; -webkit-text-stroke: 0; text-shadow: none;">OK</button>
                </div>
            </div>
        </div>
        `;
    ...
    return new Promise((resolve) => {
        ...
        <div id="customPromptModal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); display: flex; justify-content: center; align-items: center; z-index: 100000;">
            <div style="background: #f0d9b5; padding: 30px; border-radius: 8px; border: 4px solid #2e2e2e; min-width: 300px; max-width: 80%; text-align: center; font-family: 'Georgia', serif; box-shadow: 0 4px 15px rgba(0,0,0,0.5);">
                ...
                <div class="responsive-modal-buttons" style="display: flex; gap: 10px; justify-content: center;">
                    <button id="customPromptCancelBtn" style="flex: 1; padding: 12px; background: #e53e3e; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: normal; letter-spacing: 1px; font-family: 'Lilita One', cursive; font-size: 16px; transition: background 0.2s; -webkit-text-stroke: 0; text-shadow: none;">Cancel</button>
                    <button id="customPromptOkBtn" style="flex: 1; padding: 12px; background: #829769; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: normal; letter-spacing: 1px; font-family: 'Lilita One', cursive; font-size: 16px; transition: background 0.2s; -webkit-text-stroke: 0; text-shadow: none;">OK</button>
                </div>
            </div>
        </div>
        `;
