...
function raceChoiceChess(state, raceWhite, raceBlack) {
    ...
    if (raceWhite == 'classic') {
        ...
        pieces.push(
            pikeman('white', 2, 6), swordsMen('white', 1, 5), pikeman('white', 2, 5), swordsMen('white', 3, 5), swordsMen('white', 4, 5), pikeman('white', 5, 5), swordsMen('white', 6, 5), pikeman('white', 5, 6),
