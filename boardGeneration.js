...
function raceChoiceChess(pieces, board,raceWhite,raceBlack){
    ...
    if(raceBlack == 'classic'){
        ...
        pieces.push(
            swordsMen('black', 0,2), pikeman('black',1,2),swordsMen('black', 2,2), pikeman('black',3,2),pikeman('black', 4,2), swordsMen('black',5,2),pikeman('black', 6,2), swordsMen('black',72),
                                             shield('black',1,1),                                                                                              shield('black',6,2),
