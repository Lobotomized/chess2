...
const EVOLUTION_ALGORITHMS = ['minimaxDeep', 'minimaxAlphaBeta', 'minimaxAlphaBetaBudget', 'minimaxQuiescence', 'proofNumberSearch', 'bestFirstSearch', 'principalVariationSearch'];
